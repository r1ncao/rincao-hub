...
local _ESP = MainFrame:Tab("WallHack")
...
InformationSection:Label("Made in Brazil")
InformationSection:Label("by rincao © 2023 - "..osdate("%Y"))

InformationSection:Button({
	Name = "Copy Discord Invite",
	Callback = function()
		setclipboard("https://discord.gg/U79Y2dzQNK")
	end
})
